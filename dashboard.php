...
<body>
	...
	<?php include_once("./tem/header.php") ?>
	<?php include_once("./tem/catagory.php") ?>
	<?php include_once("./tem/brand.php") ?>
	<?php include_once("./tem/product.php") ?>
	<?php include_once("./tem/update_profile.php") ?>
	<!-- Navbar -->
	<br /><br />
	<div class="container">
		<div class="row">
			<div class="col-md-4 ">
				<div class="card mx-auto">
					...
					<div class="card-body">
						...
						<a href="barcodereader/index.php" eid="<?php echo $_SESSION["userid"] ?>" class="btn btn-primary" data-tog> <i class="fas fa-success"> Barcode Reader</i></a>
				...
				<div class="jumbotron" style="width:100%;height:100%;">
					...
					<div class="row">
						<div class="col py-4">
							...
							<iframe src="http://free.timeanddate.com/clock/i71t13mj/n179/szw110/szh110/hbw0/hfc000/cf100/hgr0/fav0/fiv0/mqcfff/mql15/mqw4/mqd94/mhcfff/mhl15/mhw4/mhd94/mmv0/hhcbbb/hmcddd/hsceee" frameborder="0" width="110" height="110"></iframe>
			...
			<div class="col-md-4 py-2">
				<div class="card  bg-dark text-white">
					<div class="card-body">
						...
						<p class="card-text">Here you can manage your batches and you add new batch</p>
...
document.getElementById('barcodeid').addEventListener('input', function() {
    const barcodeValue = this.value;
    
    // Check if the barcode length is greater than 8
    if (barcodeValue.length > 8) {
        // Extract the batch ID from the barcode (digits after the 8th)
        const batchId = parseInt(barcodeValue.substring(8), 10).toString();
        console.log({'batchId': batchId})
        // Select the batch dropdown
        const batchSelect = document.getElementById('select_brand');
        
        // Set the selected option based on the batch ID
        for (let i = 0; i < batchSelect.options.length; i++) {
            if (batchSelect.options[i].value === batchId) {
