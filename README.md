# Dreams Truck Shop-with-Html-Bootstrap-jQuery and-PHP-
...
#To work with create  a new folder name >> IMS2 inside your htdocs folder in xampp , inside this IMS2 folder create another folder name >> public_html inside this folder copy all the files and export the database in the mysql and run the software..
